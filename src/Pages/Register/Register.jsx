...
const Register = () => {
    return (
        <div className="flex flex-col lg:flex-row lg:my-10 w-full justify-center">
            <form className="w-full lg:w-2/3 bg-base-200 lg:ml-10 p-10">
            <h2 className="text-center font-bold text-xl lg:text-3xl py-5 lg:py-7">Resister Now</h2>
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="password" name="image" id="floating_repeat_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />

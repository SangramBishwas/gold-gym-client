...
const Login = () => {
    return (
        <div className="flex flex-col lg:flex-row lg:my-10 w-full justify-center">
            ...
            <form className="w-full lg:w-2/3 bg-base-200 lg:mr-10 p-10">
                <h2 className="text-center font-bold text-xl md:text-3xl">Log in with</h2>
                <div className="mb-5 max-w-sm mx-auto">
                    <button className="flex items-center gap-3 bg-white dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5 my-4">
